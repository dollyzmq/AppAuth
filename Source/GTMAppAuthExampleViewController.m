...
- (IBAction)userinfo:(nullable id)sender {
  ...
  [fetcher beginFetchWithCompletionHandler:^(NSData *data, NSError *error) {
    ...
    // Success response!
    [self logMessage:@"UserInfo: %@", jsonDictionaryOrArray];
  }];
}

- (IBAction)drive:(id)sender {
    [self logMessage:@"Performing drive request"];
    
//    GTLRDrive_FileList *fileList = nil;
//    NSError *fileListFetchError = nil;
